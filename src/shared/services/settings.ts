...
export async function getSettings() {
  const settings: Setting[] = [
    {
      name: 'app_name',
      title: 'App Name',
      placeholder: 'Social Security Dates',
      type: 'text',
      group: 'appinfo',
      tab: 'general',
    },
    {
      ...
      placeholder:
        'Check scheduled Social Security and SSI payment dates using public SSA payment rules.',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'socialsecuritydates.com',
      group: 'plausible',
      tab: 'analytics',
    },
    {
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'Social Security Dates <no-reply@socialsecuritydates.com>',
      group: 'resend',
      tab: 'email',
    },
    {
